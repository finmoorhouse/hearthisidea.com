...
<Layout>
<Seo title="Grants" myStaticFeaturedImage="/grants.jpg"/>

<h1>Announcing Amplify creative grants</h1>
<hr className="line" />
...
![Share image](../images/grants/grants-logo.png)
...
We’re especially focused on (i) reducing existential risk, (ii) helping fix pressing global problems, and (iii) putting humanity on a positive long-term trajectory. More details on all three below.
...
If you are unsure whether your idea fits among the areas we outline below, please lean toward applying— we want to hear your ideas! The [form](https://grants.hearthisidea.com/apply) is a single page of questions, and should easily take less than an hour. The first batch of grants will be approved around 3 weeks after this announcement. After that, we’ll approve grants on a rolling basis. Let us know if you have a deadline you need to hear back by, and we’ll do our best to stick to it and get back very quickly if necessary. If you have any questions which aren’t answered below, please contact us on [grants@hearthisidea.com](mailto:grants@hearthisidea.com).

**You can apply now by [following this link](https://grants.hearthisidea.com/apply).**

## We want to support podcasts and creative projects with a plan for impact
...
## Grants can cover time, equipment, or support
...
- You want to make a historical podcast series — e.g. about how vaccines were developed and normalised; how the deep learning paradigm arose; the lives of moral entrepreneurs like [Norman Borlaug](https://en.wikipedia.org/wiki/Norman_Borlaug) or [Grace Eldering](https://en.wikipedia.org/wiki/Grace_Eldering); or how the campaign to eradicate smallpox succeeded. You aim to use the historical insights to **advocate** for a better way of thinking about an important problem. 
...
- You want to record some EA writing you think is great as an audio podcast, or animated youtube video.
...
- This program is supported by the [FTX Future Fund regranting program](https://ftxfuturefund.org/announcing-our-regranting-program/)
- We’ll aim to respond to your grant application **within 3 weeks of this announcement.**
- As long as we still have funds to disburse, we’re committing to reviewing applications **until November 30th**. After that point, we will likely continue to review applications on a rolling (and possibly slower) basis.
- Applications will be handled by [Toby Tremlett](https://twitter.com/toby_tremlett), an author and podcaster with a focus on media within effective altruism. [Luca](https://www.lucarighetti.com/) and [Fin](https://www.finmoorhouse.com/) will also give input.
- If you have **any questions** about the application progress, or something is stopping you from applying (maybe you worry that this grant isn’t for you), please contact Toby at [grants@hearthisidea.com](mailto:grants@hearthisidea.com)
