...
**October 22nd update:** we've been really impressed with  the number and quality of applications over the last few weeks; enough  to disburse all of our initial pot to the (successful) applications we  have already received. As such, we will **no longer be actively considering new applications** for the first set of grants. However, **we will keep the application form open for the time being as a way to express interest** in case we renew the program. Thanks for your understanding!
...
- We'll update this announcement if / when we're no longer accepting applications (because we use all our available funds, or no longer have capacity to evaluate applications).
