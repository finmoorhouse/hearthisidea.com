...
const DonatePage = () => (
  <Layout>
    ...
    <p>
      Special thank you to the <a href='https://funds.effectivealtruism.org/funds/ea-community' target='_blank'>EA Infrastructure Fund</a> for supporting us with a{" "}
      <a
      ...
      </a> This covered our time as we worked on the podcast over the pandemic. If you have a project you think could improve the world, we highly recommend thinking about <a href='https://funds.effectivealtruism.org/apply-for-funding' target='_blank'>applying to an EA Fund</a>!
    </p>
