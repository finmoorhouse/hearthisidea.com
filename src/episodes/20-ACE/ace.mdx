...
![Leah and Manja](images/leah-and-manja.jpg)
...
<div className="bookshelf" > <Book url="https://animalcharityevaluators.org/blog/" image="book-ace-1"/> <Book url="https://www.vox.com/future-perfect-podcast" image="book-ace-2"/> <Book url="https://www.openphilanthropy.org/farm-animal-welfare-newsletter-archive" image="book-ace-3"/> </div><br/>
...
![Animal donations](images/animal-donations.jpg)
...
> There's a lot of opporunities out there to improve the lives of farmed animals. So we view that cause area for a donor or an activist who really wants to think about how their individual advocacy can help the highest number of animals and make the biggest difference.
...
![GFI Theory of change](images/gfi.jpg)
...
![EA Influence](images/ea_gifts.png)
