...
path: "/episodes/julia"
date: "2021-01-25"
title: "Julia Schvets on Overconfidence, Rank Incentives, and Lab vs Field Experiments"
audio: ""
featuredImage: "images/julia_featured.png"
backgroundImage: "images/running.webp"
spotify: ""
apple: ""
google: ""
status: "wip"
...
The first of Julia's papers we discuss is "[Persistent overconfidence and biased memory: Evidence from managers](https://static1.squarespace.com/static/57bf5311197aea28a6b5c1f0/t/5d0b432f1b89af00016ebad3/1561019187408/Overconfidence_Huffman_Raymond_Shvets_05_03_19.pdf)" (2019).
...
![Overconfident update](images/bayesian-update.png)
...
![Overconfident update](images/overconfident-update.png)
...
![Processes](images/info-process-belief.png)
...
Additionally, the firm gives managers detailed feedback every quarter, including information about their performance and the distribution of other managers' performance. As Julia describes:
...
To test for overconfidence, the authors then ask the managers to forecast their rank for the next quarter. Managers get a small financial reward for accurate guesses, incentivising them further. The authors then compared these results with the actual data.
...
![Recalled performance](images/recalled-performance.png)
...
Julia pointed out that a quirk in her data allowed her to test for the "rank effect" directly. Recall that manager's bonuses get determined by their quintile. This fact means that if rank and financial incentives aren't directly correlated — instead, their relationship follows a step-wise pattern. As Julia notes:
...
We can also see this in the diagram below. If people care only about rank incentives, then being close to a "boundary" shouldn't matter that much — the difference in rank is only marginal. But if people care about financial incentives, then these boundaries should be critical — as they make or break what bonus you end up getting. Thus, seeing how much effort "oscillates" with boundaries can give us a direct measure of rank effects.

![Profit rank and score](images/profit-rank.png)
...
In economic terms, we are interested to see if the utility from rank is *convex* or *concave*. If it is convex, people will have a desire to catch-up; if it is concave, people will desire to give up. We can show this in the diagram below:

![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/faa873c4-efcc-4b1d-b6db-40cc87d2859b/Untitled.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/faa873c4-efcc-4b1d-b6db-40cc87d2859b/Untitled.png)
...
- Other working paper's on rank incentives — [here](https://faculty.wharton.upenn.edu/wp-content/uploads/2012/07/rankincentives_1.pdf), [here](https://dash.harvard.edu/bitstream/handle/1/4415904/Zeckhauser%20Rank%20Incentive.pdf), and [here](https://www.sciencedirect.com/science/article/abs/pii/S0047272712000436).
